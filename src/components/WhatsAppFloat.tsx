...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="hidden lg:flex fixed bottom-5 right-5 z-50 bg-[#25D366] text-white w-14 h-14 rounded-full shadow-lg items-center justify-center hover:scale-110 transition-transform"
    >
